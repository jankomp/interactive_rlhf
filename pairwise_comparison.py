...
tb_log_name = 'pairwise_comparison_05'
# END: PARAMETERS
...
#preference_model = preference_comparisons.PreferenceModel.load_model(logs_folder + f"/rlhf_pairwise_preference_model_{chosen_environment_short_name}", reward_net)
...
#agent = PPO.load('rlhf_pairwise_policy_model_' + chosen_environment_short_name)
