    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        MujocoEnv.__init__(
            self, "half_cheetah.xml", 5, observation_space=observation_space, height=DEFAULT_SIZE, width=DEFAULT_SIZE, **kwargs
        )
...
register(
    id='HalfCheetah-v4.1',
    entry_point='src.imitation.util.custom_envs.half_cheetah_v4_1:HalfCheetahEnv',
