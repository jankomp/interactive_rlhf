    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        MujocoEnv.__init__(
            self, "walker2d.xml", 4, observation_space=observation_space, height=DEFAULT_SIZE, width=DEFAULT_SIZE, **kwargs
        )
...
register(
    id='Walker2d-v4.1',
    entry_point='src.imitation.util.custom_envs.walker2d_v4_1:Walker2dEnv',
