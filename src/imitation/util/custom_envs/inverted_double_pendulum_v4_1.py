...
class InvertedDoublePendulumEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        terminated = self.terminate_when_unhealthy and bool(y <= 1)
...
register(
    id='InvertedDoublePendulum-v4.1',
    entry_point='src.imitation.util.custom_envs.inverted_double_pendulum_v4_1:InvertedDoublePendulumEnv',
