    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        MujocoEnv.__init__(
            self, xml_file, 5, observation_space=observation_space, height=DEFAULT_SIZE, width=DEFAULT_SIZE, **kwargs
        )
...
register(
    id='Ant-v4.1',
    entry_point='src.imitation.util.custom_envs.ant_v4_1:AntEnv',
