...
class InvertedPendulumEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, terminate_when_unhealthy=False, **kwargs):
    ...
    def step(self, a):
        ...
        ob = self._get_obs()
        terminated = self._terminate_when_unhealthy and bool(not np.isfinite(ob).all() or (np.abs(ob[1]) > 0.2))
...
register(
    id='InvertedPendulum-v4.1',
    entry_point='src.imitation.util.custom_envs.inverted_pendulum_v4_1:InvertedPendulumEnv',
