...
class ReacherEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, terminate_when_unhealthy=False, **kwargs):
        ...
        MujocoEnv.__init__(
            self, "reacher.xml", 2, observation_space=observation_space, height=DEFAULT_SIZE, width=DEFAULT_SIZE, **kwargs
        )
...
register(
    id='Reacher-v4.1',
    entry_point='src.imitation.util.custom_envs.reacher_v4_1:ReacherEnv',
