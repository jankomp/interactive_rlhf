...
#TODO: fix ValueError: XML Error: Schema violation: unrecognized attribute: 'collision'
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        MujocoEnv.__init__(
            self, "swimmer.xml", 4, observation_space=observation_space, height=DEFAULT_SIZE, width=DEFAULT_SIZE, **kwargs
        )
...
register(
    id='Swimmer-v4.1',
    entry_point='src.imitation.util.custom_envs.swimmer_v4_1:SwimmerEnv',
